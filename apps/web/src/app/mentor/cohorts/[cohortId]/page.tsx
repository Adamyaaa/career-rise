  ...
  return (
    <>
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <PageHeading
          title={cohort ? cohort.course.title : "Cohort"}
          description={cohort ? `${cohort.name} · started ${formatDate(cohort.startDate)}` : undefined}
        />
        {!showUpload && (
          <Button onClick={() => setShowUpload(true)} className="w-fit self-end">
